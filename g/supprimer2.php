...
<div class="box">
  ...
  <input type="submit" name="supprimer" value="supprimer"> 
     ...
     if($conn -> query($sql) === TRUE){      //si la suppression avec sucès alors :
        header("Location:affichage.php") ;//Si le nombre de ligne est > 0 , on sera redirigé vers la page bienvenu
    } else {      //sinon
        header("Location:supprimer2.php") ;//Si le nombre de ligne est > 0 , on sera redirigé vers la page bienvenu
    }
        }
